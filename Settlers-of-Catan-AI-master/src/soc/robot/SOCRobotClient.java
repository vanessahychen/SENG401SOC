...
public class SOCRobotClient extends SOCDisplaylessPlayerClient
{
     ...
     */
    protected Hashtable robotBrains = new Hashtable();
     ...
     */
    protected Hashtable gameOptions = new Hashtable();
     ...
     */
    public SOCRobotClient(String h, int p, String nn, String pw, boolean theirs)
    {
        gamesPlayed = 0;
        gamesFinished = 0;
        gamesWon = 0;
     ...
     * @param pw   password for robot
     */
    public SOCRobotClient(String s, String nn, String pw, boolean theirs)
    {
        this(null, 0, nn, pw, theirs);
        strSocketName = s;
    }
	...
	SOCGame ga = new SOCGame(gaName, true, (Hashtable) gameOptions.get(gaName));
        ...
        // Uses our AI instead of theirs
        // SOCRobotBrain rb = new SOCRobotBrain(this, currentRobotParameters, ga, brainQ);
       /* int strategy= currentRobotParameters.getStrategyType();
        SOCRobotBrain rb;
        if (strategy== SOCRobotDM.OUR_STRATEGY){
        	rb = new SOCOurBrain(this, currentRobotParameters, ga, brainQ);
        } else {
        	rb= new SOCRobotBrain(this, currentRobotParameters, ga, brainQ);
        } */
       // SOCOurBrain rb = new SOCOurBrain(this, currentRobotParameters, ga, brainQ);
        

        // Uses our AI instead of theirs, or vice versa
        SOCRobotBrain rb;
        if(useTheirRobot)
        	rb = new SOCRobotBrain(this, currentRobotParameters, ga, brainQ);
        else
    ...
    public static void main(String[] args)
    {
        ...
        SOCRobotClient ex1 = new SOCRobotClient(args[0], Integer.parseInt(args[1]), args[2], args[3], true);
        ex1.init();
    }
}
