...
public class SOCResourceSet implements Serializable, Cloneable
{
    ...
    /**
     * Added by Ryan: copy constructor for SOCResourceSet
     */
    public SOCResourceSet(SOCResourceSet s) {
    ...
    /** added by Katie multiply all the values in this resource set by n*/
