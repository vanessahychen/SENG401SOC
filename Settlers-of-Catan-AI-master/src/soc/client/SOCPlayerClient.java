...
public class SOCPlayerClient extends Applet implements Runnable, ActionListener, TextListener, ItemListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9067508850668311206L;
...
//            practiceServer.setupLocalRobots(2,5);
            //practiceServer.setupLocalRobots(1,1,1);
            // TODO: Ryan set number of theirs/number of ours
            practiceServer.setupLocalRobots(1, 3);
        }
        if (prCli == null)
        {
            try
        ...
        throws IllegalArgumentException
    {
        ...
        // We need some opponents.
        // Let the server randomize whether we get smart or fast ones.
        localTCPServer.setupLocalRobots(2,5);
       //localTCPServer.setupLocalRobots(1,1,1);
     ...
     */
    public class SOCPlayerLocalStringReader implements Runnable
    {
